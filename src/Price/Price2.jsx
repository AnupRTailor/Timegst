...
{/* -------------------------------------------------------------------------------------------------------------------------------------------------------- */}
          ...
          <form>
                ...
                <label htmlFor="phone" className="price9">Phone</label><span class="name-danger">*</span><br/>
                <input type="tel" id="phone" name="phone" className="phone"/><br/><br/>

                <label htmlFor="order_notes"  className="price10">Order Notes</label><span class="name-danger">*</span><br/>
                <namearea id="order_notes" name="order_notes" className="order_notes" rows="4" cols="50"  placeholder="Write your notes here..."></namearea><br/><br/>
...
{/* ---------------------------------------------------------------------------------------------------------------------------------------------------------------- */}
          ...
          <div className="price15">
            ...
            <table className = "price16">
              ...
              <tbody>
                <tr>
                  <td>professional 1year</td>
                  <td>4500.00</td>
                </tr>
                <tr>
                  <td className="price17">Order Total</td>
                  <td className="price17">4500.00</td>
                </tr>
              </tbody>
            </table>
